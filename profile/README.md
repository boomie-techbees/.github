...
| [wincraft-claude-code](https://github.com/boomie-techbees/wincraft-claude-code) | WinCraft maintained | Claude Code | [Try it](https://gleeful-puffpuff-8beac5.netlify.app) (no signup, data stored locally) |
